...
namespace ConsoleApp1
{
    public class PorNombre : EstrategiaDeComparacion
    {
        ...
        public bool sosMayor(Alumno alumno1, Alumno alumno2) { return string.Compare(alumno1.getLegajo().ToLower(), alumno2.getLegajo().ToLower()) > 0; }
        public bool sosMenor(Alumno alumno1,Alumno alumno2){ return string.Compare(alumno1.getLegajo().ToLower(), alumno2.getLegajo().ToLower()) < 0; }
    }
}